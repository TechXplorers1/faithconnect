  ...
  function onSubmit(values: z.infer<typeof eventSchema>) {
    const handleImage = (file: File, callback: (imageUrl?: string, imageId?: string) => void) => {
        if (file) {
            ...
            callback(undefined, `event-${Math.floor(Math.random() * 3) + 1}`);
        }
    };
        ...
        <CardContent>
             <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem><FormLabel>Location</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormMessage></FormItem>
                    )} />
